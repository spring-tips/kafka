 ...
 */
public class AutoConfigurationPackages_BasePackages__BeanDefinitions {
  /**
  ...
  public static BeanDefinition getAutoConfigurationPackagesBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, new String[] {"bootiful"});
